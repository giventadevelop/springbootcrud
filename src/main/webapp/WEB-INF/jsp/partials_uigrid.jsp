...
<body id="page-top" class="index">
	...
	<div class="panel panel-default">
		...
		<div class="panel-heading">
			<span class="lead"> Dog's List </span>
			<div class="panel-title pull-right">  <button type="button" class="btn btn-info" ng-click="openCreateDogModal()" >Create New Dog</button></div>
