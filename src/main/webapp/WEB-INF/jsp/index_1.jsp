...
<script src="js/app/TestCodeController.js"></script>
...
<body id="page-top" class="index">
	<div class="container">
		...
		<nav id="mainNav"
			...
			<div class="collapse navbar-collapse"
				...
				<ul class="nav navbar-nav navbar-right">
					...
					<li><a href="login">Login_Test_1</a></li>
					<li><a href="login">Login_Test_2</a></li>
					<li><a href="homepage">Home_Test</a></li>
					<li><a ui-sref="home">Home</a></li>
					<li><a ui-sref=uigrid>UI Grid</a></li>
					<li><a ui-sref="angtiles">Ang Tiles</a></li>
					<li><a ui-sref="testcode">Test Code</a></li>
				</ul>
		...
		<div
			style="padding-left: 30px; padding-right: 30px; padding-top: 100px; padding-bottom: 30px"">


			Hello World jsp! !!!You are Home!!!
