...
public class CucumberRestTest {
	...
	private static final Logger logger = LogManager.getLogger(CucumberRestTest.class);
...
*/
    ...
    public void usersGetInformationOnAProject(String projectName) throws IOException {
    	...
    	logger.debug("The When call in CucumberRestTest.class with input "+projectName);
    	/*wireMockServer.start();
   ...
   /* @Then("^the server should handle it and return a success status$")
    ...
    public void theRequestedDataIsReturned() {
    	...
    	logger.debug("The GET call returned CucumberRestTest.class");
    }
